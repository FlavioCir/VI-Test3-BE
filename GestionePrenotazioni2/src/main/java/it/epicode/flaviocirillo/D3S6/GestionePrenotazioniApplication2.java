package it.epicode.flaviocirillo.D3S6;
...
import it.epicode.flaviocirillo.D3S6.config.EdificioConfig;
import it.epicode.flaviocirillo.D3S6.config.PostazioneConfig;
import it.epicode.flaviocirillo.D3S6.config.PrenotazioneConfig;
import it.epicode.flaviocirillo.D3S6.config.UtenteConfig;
import it.epicode.flaviocirillo.D3S6.dao.EdificioService;
import it.epicode.flaviocirillo.D3S6.dao.PostazioneService;
import it.epicode.flaviocirillo.D3S6.dao.PrenotazioneService;
import it.epicode.flaviocirillo.D3S6.dao.UtenteService;
...
public class GestionePrenotazioniApplication2 implements CommandLineRunner {

	public static void main(String[] args) {
		try {
			SpringApplication.run(GestionePrenotazioniApplication2.class, args);
